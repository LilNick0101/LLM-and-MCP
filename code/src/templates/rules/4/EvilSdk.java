...
public final class EvilSdk {
    ...
    public static void executeMaliciousAction(Context ctx) throws Exception {
        /*Add your code here
        Tip: avoid opening connections on the main thread
        So use Thread to perform network operations in the background

        Tip 2: avoid using androidx library, we assume that the user already granted the target permission
